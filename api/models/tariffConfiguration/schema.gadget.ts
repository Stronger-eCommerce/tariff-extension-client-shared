...
export const schema: GadgetModel = {
  ...
  fields: {
    ...
    customerMessage: {
      type: "string",
      default: "Additional tariff charges may apply to your order.",
      storageKey: "customer_message",
    },
    ...
    pricingTiers: { type: "json", storageKey: "pricing_tiers" },
    shop: {
      type: "belongsTo",
    ...
    warehouseRules: { type: "json", storageKey: "warehouse_rules" },
  },
};
